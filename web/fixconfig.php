...
try {
  require_once __DIR__ . '/core/lib/Drupal/Component/Serialization/Yaml.php';
  ...
  echo "OK: Portfolio config restored (" . count($data['resourceFields']) . " fields)\n";
  echo "created disabled: " . ($data['resourceFields']['created']['disabled'] ? 'true' : 'false') . "\n";
  echo "title disabled: " . ($data['resourceFields']['title']['disabled'] ? 'true' : 'false') . "\n";
} catch (Exception $e) {
