...
if (isset($_GET['restore'])) {
  ...
  try {
    ...
    echo "Has title: " . (isset($data['resourceFields']['title']) ? 'yes (' . ($data['resourceFields']['title']['disabled'] ? 'disabled' : 'enabled') . ')' : 'no') . "\n";
    
    // Add missing fields from news config structure
